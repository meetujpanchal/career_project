    ...
    <body id="page-top">        
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="#portfolio">Course</a></li>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Career Counselling</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Course - Career - College</p>
            </div>
        </header>
        <!-- Portfolio Section-->
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <!-- Portfolio Item 1-->
                        <?php
                             include("dbconfig.php");
                             $result=mysqli_query($cn,"SELECT * FROM course ORDER BY cid DESC LIMIT 3") or die("error in select query");
                ...
                <div class="text-center mt-4">
                    <button class="btn btn-primary" href="viewmorecourse.php" data-bs-dismiss="modal">
                        <a href="viewmorecourse.php" class="btn btn-primary btn-md" role="button"><i>View More Courses</i></a>
                    </button>
                </div>
            </div>
        </section>
        <!-- Portfolio Section-->
        <section class="page-section portfolio" id="portfolio1">
            <div class="container">
                <!-- Portfolio Section Heading-->
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">College</h2>
                <!-- Icon Divider-->
                <div class="divider-custom">
                    <div class="divider-custom-line"></div>
                    <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                ...
                <div class="row justify-content-center">
                    <!-- Portfolio Item 1-->
                        <?php
                             include("dbconfig.php");
                             $result=mysqli_query($cn,"SELECT * FROM college ORDER BY c_id DESC LIMIT 3") or die("error in select query");
                            while ($r=mysqli_fetch_array($result)) {?>
                    <div class="col-md-6 col-lg-4 mb-5">        
                        <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal1">
                            <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                ...
                <div class="text-center mt-4">
                    <button class="btn btn-primary" href="#!" data-bs-dismiss="modal">
                        <a href="viewmorecollege.php" class="btn btn-primary btn-md" role="button"><i>View More Colleges</i></a>
                    </button>
                </div>
            </div>
        </section>
        ...
        <section class="page-section bg-primary text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12"><p class="lead" align="justify">Choosing a career can help you select the right education and skills you need to obtain to support that career. Making careful and well-thought-out decisions regarding your career can increase your chance of success. Choosing the right career can take time and research. In this article, we explore in-depth what a career is, share different kinds of career paths, plus offer some tips to help you find the right career.</p></div>
                    ...
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <form id="contactForm" method="POST" data-sb-form-api-token="API_TOKEN">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="name" type="text" placeholder="Enter your name..." name="nm" data-sb-validations="required" />
                            ...
                            <!-- Submit Button-->
                            <button class="btn btn-primary btn-xl disabled" id="submitButton" type="submit" name="btnsub">Send</button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        ...
                        <p class="lead mb-0">
                            ...
                            <br />
                            <a href="#!" class="text-white">College</a>
                            </br>
                    ...
                    <!-- Footer About Text-->
                    <div class="col-lg-4">
                        <h4 class="text-uppercase mb-4">Career Counselling</h4>
                        <p class="lead mb-0">
