<?php
 ...
 if(isset($_POST['btnsub'])){
    ...
    $result=mysqli_query($cn,"Insert into course(cname,cfees,cduration,cdescri,image,urls)values('".$_POST['cnm']."','".$_POST['cfs']."','".$_POST['cdr']."','".$_POST['cdes']."','$destinationfile','".$_POST['ur']."')")or die("Error In Insert Query");
                           ...
                           <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="ur" required>
                                </div>
                            </div>
                             <div class="row row-space">
                            <div class="col-2">
