                ...
                while ($r = mysqli_fetch_array($result)) { ?>
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal1">
                            ...
                            <img class="img-fluid" src="admin/views/sb_assets/<?php echo $r['image']; ?>" width="450"
                                height="450" alt="...">
                        </div>
                        <?php if (isset($_SESSION['login_user'])) { ?>
                            <h3><a href="details.php?cid=<?php echo $r['cid']; ?>">
                                    <?php echo $r['cname']; ?>
                                </a></h3>
                            <?php
                        } else { ?>
                            <h3><a href="detailsc.php?cname=<?php echo $r['cname']; ?>">
                                    <?php echo $r['cname']; ?>
                                </a></h3>
                        <?php } ?>
                    </div>
