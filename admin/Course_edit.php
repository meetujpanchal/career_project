                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="cnm"
                                        value="<?php echo $r['cname']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="row row-space">
                                <div class="col-2">
                                    <div class="input-group">
                                        ...
                                        <input class="input--style-4" type="text" name="cfs"
                                            value="<?php echo $r['cfees']; ?>">
                                    </div>
                                </div>
                                        ...
                                        <div class="col-2">
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" rows="5" id="comment"
                                                    name="cdes"><?php echo $r['cdescri']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-2">
                                            <div class="row row-space">
