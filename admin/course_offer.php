...
<div class="class-add">
  <table align="right">
    <tr >
      <td><a href="addcourse_offer.php" class="btn btn-primary btn-lg" role="button"><i class="bi bi-plus-circle"></i></a></td>
    </tr>
  </table>
</div>
...
<tr>
<?php 
  $cr=mysqli_query($cn,"select * from cource_offer where c_id=".$r['c_id']);
