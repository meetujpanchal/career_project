<?php
 ...
 if(isset($_POST['btnsub'])){
    $result=mysqli_query($cn,"Update facility_offer set clgname='".$_POST['clgname'].",cname='".$_POST['cname']."'where f_id=".$_REQUEST['foffer_id'])or die("Error In Update Query");
    header("location:course_offer.php");
   exit();
 }
 $result=mysqli_query($cn,"select * from facility_offer where f_id=".$_REQUEST['foffer_id'])or die("Error in select Query");
    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Facility Offer</h2>
                    <form method="POST">
