<?php
 ...
 if(isset($_POST['btnsub'])){
    $result=mysqli_query($cn,"Update course set cname='".$_POST['cnm']."',cfees='".$_POST['cfs']."',cduration='".$_POST['cdr']."',cdescri='".$_POST['cdes']."' where cid=".$_REQUEST['course_id'])or die("Error In Update Query");
                           ...
                           <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="cdr" value="<?php echo $r['cduration'];?>">
                                </div>
                            </div>
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Course Descriperation </label>
                                    <textarea class="form-control" rows="5" id="comment" name="cdes" value="<?php echo $r['cdescri'];?>"></textarea>
                                </div>
                            </div>
                        <div class="p-t-15">
