...
?>  
<h2 style="text-align: justify;" id="chp_overview_toc_3">BCA Specialisations</h2> 
<p style="text-align: justify;">Some popular BCA specialisations available for admission&nbsp; are:</p> 
...
<h2 style="text-align: justify;" id="chp_overview_toc_5">Top BCA Colleges in India: Fees and Salary</h2> 
<p style="text-align: justify;">A number of colleges offer BCA admission and hence sometimes it becomes difficult to choose the best college for admission. Here is the list of some popular BCA colleges in India along with the total fees and average salary offered:</p> 
<h3 style="text-align: justify;" id="chp_overview_toc_5_0">BCA Course Offered Colleges</h3> 
<table> 
 <thead>
    <?php
    $c=mysqli_query($cn,"Select * from college_offer where cid='1' ")or die("error");

    if(mysqli_num_rows($c)>0){?>
  <tr> 
   <th> <p>Colleges Name</p> </th> 
   <th> <p>College Rank</p> </th>
  </tr>
  </thead>
  <?php
  ...
  <tbody>
  <tr>
   <td> <p><a href="<?php echo $r['urls'];?>"><?php echo $r['clgname'];?></a></p> </td>
